...
class MainPage extends React.Component {
  ...
  addNote = (noteObj) => {
    axios
      .post(
        'https://secure-taiga-54603.herokuapp.com/api/notes',
        noteObj,
  ...
  getNotes = () => {
    axios
      .get('https://secure-taiga-54603.herokuapp.com/api/notes', { headers: { "Authorization": this.props.currentUser.token }})
      .then(foundNotes => {
